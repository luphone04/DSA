import sys
from Heap import *
# an INPUT FORMAT that provides 
# the type of graph, 
# the number of vertices and edges, and 
...
# The vertex number (e.g., 1, 2, 3, ...).
# The shortest distance from the source vertex to that vertex.
# The parent vertex through which the shortest path was reached (None if the vertex is the source).
...
for t in list(zip(range(0,V+1),Shortest_Estimate, Parent)):
    print(*t)